...
1. 本文件是 Step 2 的 scope baseline 與驗收矩陣，不是目前活躍中的產品優先順序清單
2. 截至 2026-04，Step 2 主鏈已大致完成，因此本文件現在更適合作為「哪些事情當初被納入 Step 2、哪些不在 Step 2」的邊界參考
3. 若目前要跟進尚未補齊的產品缺口，請回到 [../PRD-實作進度與下一步-v1.md](../PRD-%E5%AF%A6%E4%BD%9C%E9%80%B2%E5%BA%A6%E8%88%87%E4%B8%8B%E4%B8%80%E6%AD%A5-v1.md) 與 `docs/功能開發/` 下的 Priority 文件
