...
1. 本文件主要保留「當初從零開始時，應該先做什麼」的路徑
2. 截至 2026-04，專案中的 CI、AWS 與 CD 主鏈已經建立，因此本文件中的 Step 3、Step 4、Step 5，現在主要作為維護與回顧用途
3. 若目前要追進度或決定接下來的產品補齊主題，請優先閱讀 [../PRD-實作進度與下一步-v1.md](../PRD-%E5%AF%A6%E4%BD%9C%E9%80%B2%E5%BA%A6%E8%88%87%E4%B8%8B%E4%B8%80%E6%AD%A5-v1.md) 與其對應的 Priority 詳細文件
