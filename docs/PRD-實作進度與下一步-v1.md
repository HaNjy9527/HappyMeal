...
| FR-11    | 同意與聲明            | 部分完成 | Consent API、資料保存、最小版 Consent Intro、guidance read-path guard、全站頁尾回看入口與短版非醫療提醒已完成       | 尚需精修 Consent Intro 與手機閱讀體驗            |
...
1. Consent 與免責聲明已完成最小版，下一步可聚焦手機體驗精修與實機驗收
2. 真實 AI 食物辨識
3. 正式營養資料來源
4. 前端 IA 補完與手機體驗精修
