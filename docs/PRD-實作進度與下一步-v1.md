...
| FR-11    | 同意與聲明            | 部分完成 | Consent API、資料保存、Consent Intro 閱讀精修、guidance read-path guard、全站頁尾回看入口、短版非醫療提醒與手機實機驗收已完成 | 後續細節打磨可移交 Priority 4                    |
...
| 驗收條件                                         | 目前狀態 | 判讀                                                                                                         |
| ------------------------------------------------ | -------- | ------------------------------------------------------------------------------------------------------------ |
| 使用者可在手機完成登入、建檔、拍照分析與查看建議 | 部分完成 | 主鏈、Priority 1 手機實機驗收與 Consent Intro 閱讀精修已完成最小版，但完整 Home 體驗仍需精修                 |
...
1. Consent 與免責聲明已完成最小版、手機實機驗收與 Consent Intro 閱讀精修，下一步可聚焦整體手機體驗精修
2. 真實 AI 食物辨識
3. 正式營養資料來源
4. 前端 IA 補完與手機體驗精修
